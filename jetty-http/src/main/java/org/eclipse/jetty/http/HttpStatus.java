...
public class HttpStatus
{
    ...
    @Deprecated
    static final public int REQUEST_ENTITY_TOO_LARGE_413 = 413;
    public static final int PAYLOAD_TOO_LARGE_413 = 413;
    @Deprecated
    static final public int REQUEST_URI_TOO_LONG_414 = 414;
    public static final int URI_TOO_LONG_414 = 414;
    public static final int UNSUPPORTED_MEDIA_TYPE_415 = 415;
    @Deprecated
    static final public int REQUESTED_RANGE_NOT_SATISFIABLE_416 = 416;
    ...
    public enum Code
    {
        ...
        {
            return String.format("[%03d %s]",this._code,getMessage());
        }
