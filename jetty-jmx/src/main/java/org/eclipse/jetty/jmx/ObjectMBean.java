...
public class ObjectMBean implements DynamicMBean
{
    ...
    public MBeanInfo getMBeanInfo()
    {
        try
        {
            if (_info==null)
            {
                ...
                influences.add(getClass()); // always add MBean itself
            ...
            if (r!=null )
            {
                ...
                else
                {
                    ...
                    while (clazz != null)
                    {
                        ...
                        {
                            return _mbeanContainer.findMBean(r);
                        }                   
    ...
    public MBeanAttributeInfo defineAttribute(Method method, ManagedAttribute attributeAnnotation)
    {
        ...
        if (!readonly)
        {
            ...
            for (int m = 0; m < methods.length; m++)
            {
                ...
                if (!"".equals(declaredSetter) && methods[m].getName().equals(declaredSetter) && methods[m].getParameterTypes().length == 1) {
				    if (setter != null)
				    {
    ...
    private MBeanOperationInfo defineOperation(Method method, ManagedOperation methodAnnotation)
    {
        ...
        try
        {
            ...
            if (impactName==null || "UNKNOWN".equals(impactName)) {
